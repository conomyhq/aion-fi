import svgPaths from "./svg-9abtt366bm";
...
function Frame5492() {
  return (
    <div className="bg-white h-[0.212px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[0.026px] border-[rgba(31,31,31,0.1)] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
